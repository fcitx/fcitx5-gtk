...
static void
_fcitx_connection_appear(G_GNUC_UNUSED GDBusConnection *connection, G_GNUC_UNUSED const gchar *name,
...
static void
_fcitx_connection_vanish(G_GNUC_UNUSED GDBusConnection *connection, G_GNUC_UNUSED const gchar *name,
                         gpointer user_data)
{
    FcitxConnection* self = (FcitxConnection*) user_data;
...
static void
_fcitx_connection_bus_finished(G_GNUC_UNUSED GObject *source_object, GAsyncResult *res,
                               gpointer user_data)
{
