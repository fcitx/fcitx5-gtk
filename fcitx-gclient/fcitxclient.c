...
void
_fcitx_client_process_key_cb(G_GNUC_UNUSED GObject *source_object,
                             GAsyncResult *res,
                             gpointer user_data)
{
...
void _fcitx_client_process_key_cancelled(G_GNUC_UNUSED GCancellable* cancellable, gpointer user_data)
{
    ProcessKeyStruct* pk = user_data;
    _process_key_data_free(pk);
}
...
static void
_fcitx_client_create_ic(G_GNUC_UNUSED FcitxConnection* connection, gpointer user_data)
{
...
static void
_fcitx_client_disconnect(G_GNUC_UNUSED FcitxConnection* connection, gpointer user_data)
{
    FcitxClient *self = user_data;
    _fcitx_client_clean_up(self, FALSE);
}
...
static void
_fcitx_client_g_signal(G_GNUC_UNUSED GDBusProxy *proxy,
